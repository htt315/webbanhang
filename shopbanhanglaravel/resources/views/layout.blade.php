                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/trang-chu')}}"><img src="{{asset('public/frontend/images/partner4.png')}}" alt="" /></a>
                        </div>
                    ...
                    <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            ...
                            {{--     <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('public/frontend/images/slide1.png')}}" class="" alt="" />
                                </div>
                            </div>
                            <div class="item">
                               {{--  <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('public/frontend/images/slide2.png')}}" class="{{-- girl img-responsive --}}" alt="" />
                            ...
                            <div class="item">
                               {{--  <div class="col-sm-6">
                                ...
                                <div class="col-sm-6">
                                    <img src="{{asset('public/frontend/images/slide3.png')}}" class="" alt="" />
